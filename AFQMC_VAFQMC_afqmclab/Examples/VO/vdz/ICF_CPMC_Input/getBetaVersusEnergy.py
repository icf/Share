...
HNumReal, HNumImag = np.loadtxt( "HNum_1.dat",  unpack=True )
DenReal, DenImag   = np.loadtxt( "den_1.dat",   unpack=True )
...
np.savetxt("energyVersusBeta.dat", np.column_stack( (EReal,EImag) ), fmt=('%26.16e','%26.16e') )
