...
#model parameters
#####################################################################
atoms             = [['N',(0.000,0.000,0.000)],['N',(0.000,0.000,2.2225444458*_icf_bondLength_/4.2)]]
chrg              = 0
spn               = 0
basis             = 'cc-pVDZ'
...
writeNumber                          = 200
measureNumberPerWrite                = 1
measureSkipStep                      = 1
walkerSizePerThread                  = 4
...
ETAdjustStep                         = 1
ETAdjustMaxSize                      = 1
ETAndBackGroundGrowthEstimateStep    = 1
ETAndBackGroundGrowthEstimateMaxSize = 1
seed                                 = 111
...
canonic = CanonicalBais(mol, rhf, 1e-8)
writeInputForModel_forGeneralHamiltonian_load_hamiltonian_and_selfCheck(mol, rhf, canonic, 1e-12, Jastrow_model_address, "model_param")
