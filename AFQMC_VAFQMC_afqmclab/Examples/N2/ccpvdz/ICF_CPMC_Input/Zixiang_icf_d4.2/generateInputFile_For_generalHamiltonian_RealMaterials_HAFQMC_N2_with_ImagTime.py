...
#For Metropolis
numOfChains                          = 10   #Due to TwoJastrow to One Jastrow, we only support one chain for now
...
#model
##################################################################
atoms             = [['N',(0.000,0.000,0.000)],['N',(0.000,0.000,2.2225444458*4.2/4.2)]]
chrg              = 0
spn               = 0
basis             = 'cc-pVDZ'
#psp               = 'bfd-pp'
...
############################################################
rhf.__dict__.update(pyscf.scf.chkfile.load('Zixiang_icf_d4.2/AFQMC_rhf.chk', 'scf'))
...
#
# writeInputForModel_forGeneralHamiltonian(1.0, mol, rhf, canonic, 1e-12, "model_param")
# writeROHFSD_icf(mol, rhf, canonic, "phi_BG.dat")
#
writeInputForModel_forGeneralHamiltonian_load_hamiltonian_and_selfCheck(mol, rhf, canonic, 1e-12, "Zixiang_icf_d4.2/AFQMC_hamiltonian.pkl", "model_param")
# writeInputForModel_forGeneralHamiltonian_load_hamiltonian_and_selfCheck(mol, rhf, canonic, 1e-12, "Zixiang_d2.1/hamiltonian.pkl", "model_param")
# writeInputForModel_forGeneralHamiltonian_load_hamiltonian_and_selfCheck(mol, rhf, canonic, 1e-12, "AFQMC_hamiltonian.pkl", "model_param")
############################################################
...
JastrowName                         = ["generalHamiltonian_HAFQMC_icf","generalHamiltonian_HAFQMC_icf"] #"realMaterial"    
...
writeInputForModel_fromHAFQMC_forGeneralHamiltonian_slice1(1.0, mol, canonic, 1e-12, "Zixiang_icf_d4.2/AFQMC_hamiltonian.pkl", "Zixiang_icf_d4.2/checkpoint.pkl", "model_Jastrow_param")
# writeInputForModel_forGeneralHamiltonian(0.1, mol, rhf, canonic, 1e-8, "model_Jastrow_param_2")
# # writeUHFSD_fromHAFQMC_icfRead(mol, canonic, "Zixiang_icf_d4.2/ckpt_24000.pkl", "phiT_0Direct.dat")
for i in range(numOfChains):
    writeUHFSD_fromHAFQMC_icfTrans(mol, canonic, "Zixiang_icf_d4.2/AFQMC_hamiltonian.pkl", "Zixiang_icf_d4.2/checkpoint.pkl", "phiT_"+str(i)+".dat")

writeUHFSD_fromHAFQMC_icfTrans(mol, canonic, "Zixiang_icf_d4.2/AFQMC_hamiltonian.pkl", "Zixiang_icf_d4.2/checkpoint.pkl", "phi.dat")
